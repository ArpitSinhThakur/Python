...
Label(root, font ='arial 15 bold', text = 'current time :', bg = 'yellow').place(x = 40 ,y = 70)
...
curr_time =Label(root, font ='arial 15 bold', text = '', fg = 'black' ,bg ='papaya whip')
...
def browsefiles():
    filename = filedialog.askopenfilename(initialder = "/",
